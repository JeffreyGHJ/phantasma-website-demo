...
function getQueryStringFromStates({
    ...
    const baseURI = "/community/treasury/ghosts";
...
const CommunityGhosts = () => {
    usePageTitle("Treasury | Phantasma");
    ...
    const handleFiltersChange = useCallback(
        ...
        [saleType, sortType, marketplaces, filters, viewType, navigate]
    );
    ...
    }, [saleType, sortType, page, marketplaces, filters, ghostsPerPage]);
    ...
    return (
        <div id="CommunityGhosts">
            {!mobileLayout && (
                <div id="Sidebar" className="scrollbar-2">
            ...
            <div
                className={`content scrollbar-2 ${mobileLayout ? "full" : ""}`}
            >
                <section
...
export default CommunityGhosts;
