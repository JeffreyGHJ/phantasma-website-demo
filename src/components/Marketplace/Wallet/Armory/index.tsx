...
function getQueryStringFromStates({
    ...
    const baseURI = `/wallet/${ownerAddress}/armory`;
...
const WalletArmories = ({ address }: { address: string }) => {
    ...
    }, [overrideStickiness, resumeStickiness, showFilterSidebar]);
