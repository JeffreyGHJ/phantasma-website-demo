...
function getQueryStringFromStates({
    ...
    const baseURI = `/wallet/${ownerAddress}/pets`;
...
const WalletPets = ({ address }: { address: string }) => {
    ...
    const handleSaleTypeOnChange = useCallback(
        ...
        [sortType, viewType, marketplaces, filters, petType, address, navigate]
    );
    ...
    const handleSortTypeOnChange = useCallback(
        ...
        [saleType, viewType, marketplaces, filters, petType, address, navigate]
    );
    ...
    const handleViewTypeChange = useCallback(
        ...
        [saleType, sortType, marketplaces, filters, petType, address, navigate]
    );
