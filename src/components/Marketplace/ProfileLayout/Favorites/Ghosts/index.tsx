...
function getQueryStringFromStates({
    ...
    const baseURI = "/marketplace/profile/favorites/ghosts";
...
const FavoriteGhosts = () => {
    ...
    }, [saleType, sortType, page, marketplaces, filters, user, ghostsPerPage]);
