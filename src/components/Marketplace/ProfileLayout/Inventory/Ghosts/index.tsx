...
function getQueryStringFromStates({
    ...
    const baseURI = "/marketplace/profile/vault/ghosts";
...
const InventoryGhosts = () => {
    ...
    useEffect(() => {
        ...
        const fetchGhostsForAccount = (currentAccount) => {
            const params = {
                limit: ghostsPerPage,
        ...
        Promise.all(allAccounts.map(fetchGhostsForAccount))
            .then((responses) => {
                responses.forEach((response) => {
                    // @ts-ignore
                    allGhosts = [...allGhosts, ...response.data];
...
export default InventoryGhosts;
