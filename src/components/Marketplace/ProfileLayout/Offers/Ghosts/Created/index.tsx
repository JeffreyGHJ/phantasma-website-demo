...
const OffersGhostsCreated = () => {
    ...
    const tokenContract = useTokenContract(littleGhostNFTAddress, true);
    ...
    const approveOfferContract = async () => {
        //@ts-ignore
        await tokenContract
            .setApprovalForAll(littleGhostNFTAddress, true)
            .then((res) => {
                handleWeb3Reponse({
                    waitingMessage:
...
export default OffersGhostsCreated;
