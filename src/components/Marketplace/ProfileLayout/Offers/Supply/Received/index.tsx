...
const OffersSuppliesReceived = () => {
    ...
    const [supplies, setSupplies] = useState([] as Array<CollectionItem>);
    ...
    useEffect(() => {
        ...
        const params = {
            ...
            saleType,
            sortType,
            ownerAddress: account, //TODO: can probably remove this
            filters,
        };
                        ...
                        return viewType === viewTypes.GRID_VIEW ? (
                            <NftCard
                                ...
                                pathPrefix={`/marketplace/${
                                    RouteUtilModel
                                        .COLLECTION_ADDRESS_TO_MARKETPLACE_ITEM_URI[
                                        item.address
                                    ]
                                }`}
                                item={item}
                                ...
                                onClick={() => {
                                    syncOffers(item.address, item.token_id);
                                }}
                            />
                        ) : (
                            <NftDetailCard
...
export default OffersSuppliesReceived;
