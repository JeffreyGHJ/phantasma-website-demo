// 0x744480f678242574bcd145bc6a3ce80b4b86510a

const pancakeLittleGhostsRewardsABI = [
	{
		inputs: [
			...
			{ internalType: 'address', name: '_ghostAddress', type: 'address' },
			{
	...
	},
	{
		inputs: [
			...
			{ internalType: 'uint256', name: '_tradingFee', type: 'uint256' },
	...
	},
	{
		...
		outputs: [
			{ internalType: 'bool[]', name: 'listingStatuses', type: 'bool[]' },
		],
		stateMutability: 'view',
		type: 'function',
	},
	...
	},
	{
		...
		outputs: [
			{ internalType: 'uint256[]', name: 'tokenIds', type: 'uint256[]' },
			{
				...
				internalType: 'struct GhostThirdParty.Ask[]',
				name: 'askInfo',
				type: 'tuple[]',
			},
			{ internalType: 'uint256', name: '', type: 'uint256' },
	...
	},
	{
		...
		outputs: [
			...
			},
			{
				components: [
					{
						internalType: 'enum GhostThirdParty.CollectionStatus',
						name: 'status',
						type: 'uint8',
					},
					{
				...
				internalType: 'struct GhostThirdParty.Collection[]',
...
export default pancakeLittleGhostsRewardsABI;
