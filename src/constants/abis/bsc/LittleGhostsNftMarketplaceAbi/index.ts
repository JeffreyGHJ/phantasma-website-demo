// 0x12492e327c49bc2f7df86d1d96752b9af1dfe2e1

const littleGhostsNftMarketplaceAbi = [
	{
		inputs: [
			{
	...
	},
	{
		...
		outputs: [
			...
			},
			{
				...
				internalType: 'struct GhostMarket.Ask[]',
				name: 'askInfo',
				type: 'tuple[]',
			},
			{ internalType: 'uint256', name: '', type: 'uint256' },
	...
	},
	{
		...
		outputs: [
			...
			},
			{
				components: [
					{
						internalType: 'enum GhostMarket.CollectionStatus',
						name: 'status',
						type: 'uint8',
					},
					{
				...
				internalType: 'struct GhostMarket.Collection[]',
...
export default littleGhostsNftMarketplaceAbi;
